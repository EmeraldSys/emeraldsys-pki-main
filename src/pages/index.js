...
const IndexPage = () => (
  <main>
    ...
    <footer className="mainFooter">
      <div>
        <p align="center" style={{ marginTop: "50px", verticalAlign: "middle", color: "rgba(255, 255, 255, 50%)" }}>Copyright &copy; {new Date().getFullYear()} EmeraldSys. All rights reserved.</p>
      </div>
    </footer>
  </main>
);
